...
from utils.library import uint256_to_ss, concat_arr
...
namespace ERC721_metadata {
    ...
    func tokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        baseTokenURI(base_token_uri_len, base_token_uri);
    ...
    func baseTokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        baseTokenURI(base_token_uri_len=base_token_uri_len - 1, base_token_uri=base_token_uri + 1);
        return ();
    }
    ...
    func setBaseTokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        _setBaseTokenURI(token_uri_len, token_uri);
    ...
    func _setBaseTokenURI{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        _setBaseTokenURI(token_uri_len=token_uri_len - 1, token_uri=token_uri + 1);
        return ();
    }
}
