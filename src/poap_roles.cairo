...
@event
func EventMinterAdded(event_id: Uint256, account: felt) {
}

@event
func EventMinterRemoved(event_id: Uint256, account: felt) {
}
...
@storage_var
func PoapRoles_minters(event_id: Uint256, account: felt) -> (is_minter: felt) {
}
